...
import '../../create_transaction_dimens.dart';
...
Future<bool?> showCreateTransactionBottomSheet(BuildContext context) {
  ...
  return showModalBottomSheet<bool>(
    ...
    builder: (_) => BlocProvider(
      ...
      child: SizedBox(
        height: screenHeight * CreateTransactionDimens.sheetHeightFactor,
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<CreateTransactionBloc, CreateTransactionState>(
      ...
      builder: (context, state) => switch (state) {
        CreateTransactionInitial() || CreateTransactionLoadingDeps() =>
          const CreateTransactionLoadingContent(),
